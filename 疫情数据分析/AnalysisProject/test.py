...
class VirusSupervise(object):
    ...
    def insert_wis_sql(self):
        ...
        coon = pymysql.connect(host=self.host_ip, user=self.host_user, password="123456", database="epidemic_data",
                               charset="utf8")
    ...
    def data_analysis(self):
        ...
        coon = pymysql.connect(host="127.0.0.1", user="root", password="123456", database="epidemic_data",charset = "utf8")
        print("连接数据库成功")
